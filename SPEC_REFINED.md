Parfait. Tes réponses clarifient très nettement le **cœur fonctionnel** du produit.
Je te propose maintenant une **PRD fonctionnelle pure**, recentrée sur les **besoins, usages, comportements attendus**, sans parler d’implémentation, d’architecture ou d’algos.

Considère ce document comme **la vérité produit**. Tout le reste devra s’y conformer.

---

# PRD fonctionnelle – Urban Change Map

**Comprendre comment un quartier va changer**

---

## 1. Intention produit (très claire)

Le produit aide à répondre à deux questions fondamentales:

> **Est-ce que ce quartier va beaucoup changer ?**
> **Est-ce que ce coin devient plus dense, plus bruyant, plus public ?**

Tout ce qui ne sert pas directement ces questions est secondaire.
...
Professionnels de l’immobilier, de la construction, de la ville.
Ils peuvent utiliser le produit, mais **il n’est pas conçu pour eux**.

---

## 3. Ce que le produit montre (et ce qu’il ne montre pas)
...
## 4. Rapport à l’incertitude (fondamental)

Le produit **assume l’incertitude**.
...
## 5. Notion centrale: la transformation d’un lieu

Le produit ne parle pas de “projets” en premier.
Il parle de **transformation d’un endroit**.
...
> “Qu’est-ce que cet endroit est en train de devenir ?”

---

## 6. Lecture spatiale: points, zones, densité
...
## 7. Lecture temporelle: raconter une histoire

Le temps n’est pas un filtre technique.
...
## 8. Maturité et statuts (sans lourdeur)
...
## 9. Ce que l’utilisateur doit comprendre en 5 minutes
...
## 10. Documents officiels et résumés

Les documents officiels ont trois rôles:

1. crédibilité
2. traçabilité
3. profondeur optionnelle
...
## 11. Échelle géographique

Le produit couvre **toute la ville**.
...
## 12. Filtrage et contrôle du bruit (critique)
...
## 13. Promesse implicite du produit
...
> **une lecture intelligible et honnête de la ville en mouvement**

---

## 14. Phrase manifeste (à garder en tête)

> **Voir comment la ville va changer, avant que ça se voie.**
